  ...
  ({ className, variant = "info", children, ...props }, ref) => {
    return (
      <div
        ...
        role="alert"
        className={cn(
          "bg-white border border-border-default border-l-4 rounded-[2.5px] p-3.5 grid grid-cols-[auto_1fr_auto] gap-x-3 gap-y-0.5 items-start [&>svg]:col-start-1 [&>svg]:row-start-1 [&>svg]:row-end-3 [&>svg]:mt-0.5",
