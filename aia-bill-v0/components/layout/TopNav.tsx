  ...
  return (
    <header className="h-12 bg-[#0A0E12] text-text-inverted flex items-center px-4 shrink-0 border-b border-[#1F2937]">
      ...
      <div className="flex items-center gap-1 ml-auto">
        <button
          type="button"
          className="inline-flex items-center gap-1.5 h-8 px-2.5 rounded-[2.5px] text-xs font-medium text-text-inverted/70 hover:text-text-inverted hover:bg-white/10 transition-colors"
        >
          <HelpCircle className="w-4 h-4" />
          <span className="hidden sm:inline">Help</span>
        </button>
        <div className="flex items-center gap-2 h-8 px-2 rounded-[2.5px] text-xs">
