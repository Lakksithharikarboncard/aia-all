      ...
      <div className="max-w-md w-full bg-white rounded-[2.5px] border border-[#d0d7de] p-10 text-center shadow-[0_1px_3px_rgba(31,35,40,0.12),0_1px_0_rgba(31,35,40,0.04)]">
        ...
        <div className="flex flex-col gap-3">
          ...
          <a
            ...
            className="inline-flex items-center justify-center rounded-[2.5px] border border-[#d0d7de] bg-[#f6f8fa] text-[#1f2328] px-6 py-2.5 text-sm font-medium hover:bg-[#ebedf0] transition-colors shadow-[0_1px_0_rgba(31,35,40,0.04)]"
          >
            Contact Support
          </a>
        </div>
